# Senderrplace Branching Template

This template standardizes branch and PR workflow for Senderrplace work.
...
- `senderrplace/feature/<short-task-name>`
- `senderrplace/fix/<short-task-name>`
- `senderrplace/docs/<short-task-name>`
