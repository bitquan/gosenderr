...
## Scope Reviewed
- Courier job detail (new): [apps/courier-app/src/pages/jobs/[jobId]/page.tsx](apps/courier-app/src/pages/jobs/%5BjobId%5D/page.tsx)
- Courier job actions: [apps/courier-app/src/features/jobs/courier/CourierJobActions.tsx](apps/courier-app/src/features/jobs/courier/CourierJobActions.tsx)
- Courier status timeline: [apps/courier-app/src/components/v2/StatusTimeline.tsx](apps/courier-app/src/components/v2/StatusTimeline.tsx)
- Courier legacy job detail: [apps/courier-app/src/pages/JobDetail.tsx](apps/courier-app/src/pages/JobDetail.tsx)
- Courier live trip UI (unused in courier app view): [apps/courier-app/src/components/v2/LiveTripStatus.tsx](apps/courier-app/src/components/v2/LiveTripStatus.tsx)

## Key Findings
1) Duplicate job detail screens with different status semantics
- The courier app has two job detail screens: the new route in [apps/courier-app/src/pages/jobs/[jobId]/page.tsx](apps/courier-app/src/pages/jobs/%5BjobId%5D/page.tsx) and the legacy page in [apps/courier-app/src/pages/JobDetail.tsx](apps/courier-app/src/pages/JobDetail.tsx).
...
- Timeline labels in [apps/courier-app/src/components/v2/StatusTimeline.tsx](apps/courier-app/src/components/v2/StatusTimeline.tsx) are generic, while the action button in [apps/courier-app/src/features/jobs/courier/CourierJobActions.tsx](apps/courier-app/src/features/jobs/courier/CourierJobActions.tsx) uses more directive verbs (Start Heading, Mark Arrived, Mark Picked Up, etc.).
...
- The “Navigate to Pickup” and “Navigate to Dropoff” buttons in [apps/courier-app/src/pages/jobs/[jobId]/page.tsx](apps/courier-app/src/pages/jobs/%5BjobId%5D/page.tsx) are always enabled (only disabled by missing location), even before pickup is complete.
...
- The banner in [apps/courier-app/src/pages/jobs/[jobId]/page.tsx](apps/courier-app/src/pages/jobs/%5BjobId%5D/page.tsx) blocks actions when payment isn’t authorized, but the timeline still shows progress as if it can advance.
...
## Action Items
- [ ] Remove or redirect legacy page [apps/courier-app/src/pages/JobDetail.tsx](apps/courier-app/src/pages/JobDetail.tsx)
