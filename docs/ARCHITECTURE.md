...
## Overview
- Monorepo with multiple apps: `marketplace-app`, `courier-app`, `admin-app`, `shifter-app`, `web`.
- Backend: Firebase (Auth, Firestore, Cloud Functions, Hosting).
- Payments: Stripe (Connect + Cloud Functions).
- Maps: Mapbox for courier routing/UI.

## App responsibilities
- `marketplace-app`: marketplace UI, ordering flow, vendor/courier interactions.
