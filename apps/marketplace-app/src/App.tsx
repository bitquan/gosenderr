...
import { startOverflowCheck } from "./lib/overflowCheck";
...
function App() {
  ...
  const messagingEnabled =
    marketplaceEnabled && (flags?.marketplace?.messaging ?? true);
  const ratingsEnabled =
    marketplaceEnabled && (flags?.marketplace?.ratings ?? true);

  useEffect(() => {
    if (!import.meta.env.DEV) return;
    if (!window.location.search.includes("debugOverflow=1")) return;
    startOverflowCheck();
  }, []);
            ...
            {flagsLoading ? (
              ...
              <Routes>
                ...
                >
                  ...
                  />
                  <Route
                    path="/profile/stripe-onboarding"
                ...
                >
                  ...
                  <Route
                    path="/reviews"
                    element={
                      ratingsEnabled ? <ReviewsPage /> : <MarketplaceDisabled />
                    }
                  />
