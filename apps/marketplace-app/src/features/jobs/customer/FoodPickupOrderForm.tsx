...
import { FoodTemperature } from "@gosenderr/shared";
...
export function FoodPickupOrderForm({ uid, restaurant }: FoodPickupOrderFormProps) {
  ...
  const { couriers, loading: couriersLoading } = useNearbyCouriers(pickupPoint, dropoff);
  ...
  return (
    <div style={{ maxWidth: "720px", margin: "0 auto", paddingBottom: "48px" }}>
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ color: "#1e40af", fontSize: "13px" }}>
              Add confirmation details so courier can verify pickup quickly.
            </div>
          </div>
        ...
        >
          {loading ? "Creating food request..." : "Request Food Pickup"}
        </button>
      </form>
    </div>
  );
