...
export type TokenAction = "job_unlock" | "listing_publish" | "cash_fee" | "ad_boost";
...
export interface TokenReservationResult {
  status: "reserved" | "not_required" | "committed" | "released";
...
export async function reserveTokenAction(input: {
  ...
  return response.data as TokenReservationResult;
}
