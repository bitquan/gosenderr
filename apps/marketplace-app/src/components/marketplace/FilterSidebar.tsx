  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-purple-950/90 text-white rounded-2xl shadow-2xl p-6 sticky top-24 border border-white/10">
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              <input
                ...
                placeholder="Min"
                className="w-full px-3 py-2 border border-white/20 bg-white/10 text-white rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
          ...
          <div className="space-y-2">
            {conditions.map((condition) => (
              <label key={condition.value} className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-sm text-white/80">{condition.label}</span>
              </label>
            ))}
          </div>
        </div>
        ...
        <button
          onClick={handleReset}
          className="w-full px-4 py-2 border border-white/20 text-white/80 rounded-lg hover:bg-white/10 transition-colors text-sm font-medium"
        >
          Reset Filters
        </button>
      </div>
