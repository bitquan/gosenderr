...
const DELIVERY_NAV: Array<NavItem & { description?: string }> = [
  {
    ...
    href: "/jobs",
    icon: "📦",
    description: "Create a package send",
  },
  {
    label: "Pickup Food",
    href: "/food-pickups",
    icon: "🍱",
    description: "Browse food pickup spots",
  },
  {
    label: "Ship",
    href: "/ship",
    icon: "🚚",
    description: "Custom courier jobs",
  },
];
    ...
    <div className="min-h-screen flex bg-gradient-to-br from-blue-950 via-purple-900 to-purple-950 text-gray-900">
      {!mobileOpen && (
        <button
          ...
          className="lg:hidden fixed top-24 sm:top-8 left-4 z-50 rounded-full border border-white/30 bg-blue-900/80 text-white px-3 py-2 text-sm font-semibold shadow"
        >
          Menu
        </button>
      )}
      ...
      <div className="hidden lg:flex relative">
        {!sidebarOpen && (
          <div className="absolute left-0 top-16 z-40 flex w-16 flex-col items-center gap-3 rounded-br-[36px] border border-white/20 bg-gradient-to-b from-blue-950/80 via-purple-950/80 to-purple-900/80 p-2 text-white/80 shadow-2xl backdrop-blur h-auto">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 relative overflow-hidden">
          ...
          <div className="relative flex-1 overflow-y-auto">
            <div className="flex-1 min-h-[calc(100vh-5rem)] px-4 pb-32 pt-3 sm:pt-6 sm:px-6 lg:px-10">
              {children}
            </div>
          </div>
        </main>
