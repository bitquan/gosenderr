        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:hidden">
            <button
              ...
              className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white flex items-center justify-center space-x-2 hover:bg-white/20 transition-colors"
            >
