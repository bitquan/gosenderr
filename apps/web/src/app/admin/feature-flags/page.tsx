...
export default function FeatureFlagsPage() {
  ...
  if (isAuthLoading || loading) {
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(to bottom right, #1e3a8a, #7c3aed)', padding: '2rem' }}>
        ...
        <div style={{ display: 'grid', gap: '1.5rem' }}>
          ...
          <GlassCard>
            ...
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('marketplace.itemListings', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('marketplace.combinedPayments', value)}
              disabled={isSaving}
            />
          </GlassCard>
          ...
          <GlassCard>
            ...
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('courier.equipmentBadges', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              label="Work Modes"
          ...
          <GlassCard>
            ...
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('customer.routeDelivery', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('customer.packageShipping', value)}
              disabled={isSaving}
            />
          </GlassCard>
          ...
          <GlassCard>
            ...
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('packageRunner.hubNetwork', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('packageRunner.packageTracking', value)}
              disabled={isSaving}
            />
          </GlassCard>
          ...
          <GlassCard>
            ...
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('admin.disputeManagement', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              label="Analytics"
          ...
          <GlassCard>
            ...
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('advanced.pushNotifications', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              ...
              onChange={(value) => handleToggle('advanced.ratingEnforcement', value)}
              disabled={isSaving}
            />
            <FeatureFlagToggle
              label="Auto Cancel"
