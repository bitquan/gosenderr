...
export default function RunnerOnboardingPage() {
  ...
  const handleVehicleSubmit = (e: FormEvent) => {
    e.preventDefault();
    if (!vehicleData.vehicleType || !vehicleData.vehicleCapacity || !vehicleData.maxWeight ||
        !vehicleData.year || !vehicleData.make || !vehicleData.model ||
        !vehicleData.licensePlate || !vehicleData.vin) {
  ...
  const handleInsuranceSubmit = (e: FormEvent) => {
    e.preventDefault();
    if (!insuranceData.file || !insuranceData.policyNumber || !insuranceData.carrier ||
        !insuranceData.coverageAmount || !insuranceData.expiresAt) {
  ...
  const handleFinalSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (insuranceData.file) {
        const storageRef = ref(storage, `insurance/${user.uid}/${Date.now()}_${insuranceData.file.name}`);
      ...
      await updateDoc(doc(db, 'users', user.uid), {
        ...
        packageRunnerProfile: {
          ...
          dotNumber: dotData.dotNumber || undefined,
          mcNumber: dotData.mcNumber || undefined,
          preferredRoutes,
          homeHub: {
      ...
      router.push('/runner/available-routes');
    } catch (err) {
  ...
  const addPreferredRoute = () => {
    setPreferredRoutes([...preferredRoutes, {
      fromHubId: '',
      toHubId: '',
      frequency: 'weekly',
      daysAvailable: [],
  ...
  return (
    <div className="container" style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '40px' }}>Package Runner Onboarding</h1>
              ...
              <form onSubmit={handleVehicleSubmit}>
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <select
                    ...
                    onChange={e => setVehicleData({ ...vehicleData, vehicleType: e.target.value as RunnerVehicleType })}
                    style={{
                      width: '100%',
                      padding: '10px',
                      borderRadius: '8px',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                  <div>
                    <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>
                      Capacity (cubic ft) <span style={{ color: '#dc2626' }}>*</span>
                    </label>
                    <input
                      type="number"
                      value={vehicleData.vehicleCapacity}
                      onChange={e => setVehicleData({ ...vehicleData, vehicleCapacity: e.target.value })}
                      style={{
                        width: '100%',
                        padding: '10px',
                        borderRadius: '8px',
                  ...
                  <div>
                    <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>
                      Max Weight (lbs) <span style={{ color: '#dc2626' }}>*</span>
                    </label>
                    <input
                      type="number"
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 2fr', gap: '20px', marginBottom: '20px' }}>
                  <div>
                    <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>
          ...
          >
            <GlassCard>
              ...
              <form onSubmit={handleInsuranceSubmit}>
                <div style={{ marginBottom: '20px' }}>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>
                    Insurance Document <span style={{ color: '#dc2626' }}>*</span>
                  </label>
                  <input
                    type="file"
                    accept="image/*,application/pdf"
                    onChange={e => setInsuranceData({ ...insuranceData, file: e.target.files?.[0] || null })}
                    style={{
                      width: '100%',
                      padding: '10px',
                      borderRadius: '8px',
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <input
                    ...
                    onChange={e => setInsuranceData({ ...insuranceData, carrier: e.target.value })}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                  <div>
                    <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>
                      Coverage Amount <span style={{ color: '#dc2626' }}>*</span>
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e => setInsuranceData({ ...insuranceData, expiresAt: e.target.value })}
                      style={{
                        width: '100%',
                        padding: '10px',
                        borderRadius: '8px',
          ...
          >
            <GlassCard>
              ...
              <p style={{ color: '#6b7280', marginBottom: '20px' }}>
                If you have DOT and MC numbers, please provide them. These are optional but recommended for interstate commerce.
              </p>
              <form onSubmit={handleDOTSubmit}>
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <input
                    ...
                    onChange={e => setDOTData({ ...dotData, dotNumber: e.target.value })}
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <input
                    ...
                    onChange={e => setDOTData({ ...dotData, mcNumber: e.target.value })}
                    placeholder="123456"
                    style={{
                      width: '100%',
                      padding: '10px',
        ...
        {currentStep === 4 && (
          ...
          >
            <GlassCard>
              ...
              <p style={{ color: '#6b7280', marginBottom: '20px' }}>
                Choose your primary hub where you'll start and end most of your routes.
              </p>
        ...
        {currentStep === 5 && (
          ...
          >
            <GlassCard>
              ...
              <p style={{ color: '#6b7280', marginBottom: '20px' }}>
                Add routes you're interested in running regularly. You can skip this and add routes later.
              </p>
                ...
                {preferredRoutes.map((route, index) => (
                  <div key={index} style={{
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                      <div>
                        <label style={{ display: 'block', marginBottom: '4px', fontSize: '14px' }}>From Hub</label>
                        <select
                          value={route.fromHubId}
                          onChange={e => updatePreferredRoute(index, 'fromHubId', e.target.value)}
                          style={{
                            width: '100%',
                            padding: '8px',
                            borderRadius: '4px',
                      ...
                      <div>
                        <label style={{ display: 'block', marginBottom: '4px', fontSize: '14px' }}>To Hub</label>
                        <select
                          value={route.toHubId}
                          onChange={e => updatePreferredRoute(index, 'toHubId', e.target.value)}
                          style={{
                            width: '100%',
                            padding: '8px',
                            borderRadius: '4px',
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e => updatePreferredRoute(index, 'frequency', e.target.value)}
                        style={{
                          width: '100%',
                          padding: '8px',
                          borderRadius: '4px',
