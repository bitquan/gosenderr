    ...
    <div style={{ padding: "12px", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        >
          ...
          >
            <span
              style={{ fontSize: "28px", fontWeight: "700", color: "#6E56CF" }}
            >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {TEMPERATURE_LABELS[item.foodDetails.temperature] ||
          ...
          >
            <button
              onClick={() => router.push(`/checkout?itemId=${itemId}`)}
              style={{
                width: "100%",
                background: "#6E56CF",
                color: "white",
            ...
            <button
              onClick={() =>
                router.push(`/customer/request-delivery?itemId=${itemId}`)
              }
              style={{
                width: "100%",
                background: "white",
