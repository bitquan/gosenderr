...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!.*(?:@react-native|react-native|@react-native-community|@react-navigation|@react-native-async-storage|@react-native-community\\+geolocation|firebase|@firebase)).*',
  ],
};
