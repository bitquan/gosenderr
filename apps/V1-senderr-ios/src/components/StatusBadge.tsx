...
import {JOB_STATUS_LABELS, type JobStatus} from '@gosenderr/contracts';
import {senderrStatusColors} from '../theme/senderrTheme';

const statusColors: Record<JobStatus, string> = senderrStatusColors;
