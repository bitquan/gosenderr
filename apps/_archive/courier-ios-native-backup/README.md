...
- See [XCODE_READY.md](XCODE_READY.md) for the readiness checklist.
- Run `./validate.sh` to verify prerequisites.
...
```sh
pnpm -C apps/courier-ios-native start
```
...
```sh
pnpm -C apps/courier-ios-native android
```
...
```sh
pnpm -C apps/courier-ios-native ios
```
