...
const FEATURE_FLAGS = [
  ...
  {
    name: "Marketplace",
    description: "Enable marketplace item listings and purchases",
    enabled: true,
    category: "marketplace",
  },
  {
    name: "Item Listings",
    description: "Allow vendors to list items for sale",
    enabled: true,
    category: "marketplace",
  },
  {
    name: "Combined Payments",
    description: "Combine marketplace and delivery payments",
    enabled: true,
    category: "marketplace",
  },
  {
    name: "Courier Offers",
    description: "Enable courier offers in checkout",
    enabled: false,
    category: "marketplace",
  },
  ...
  // Delivery
  {
    ...
    description: "Enable on-demand courier deliveries",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Route Delivery",
    description: "Enable scheduled route deliveries",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Long Routes",
    description: "Enable regional routes (50-200mi)",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Long Haul",
    description: "Enable interstate routes (200+mi)",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Live Tracking",
    description: "Real-time delivery tracking on map",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Map Shell",
    description: "Map-first courier experience (MapShell)",
    enabled: false,
    category: "delivery",
  },
  ...
  // Courier
  {
    name: "Courier Rate Cards",
    description: "Custom rate cards per courier",
    enabled: true,
    category: "system",
  },
  {
    name: "Equipment Badges",
    description: "Show equipment approval badges",
    enabled: true,
    category: "system",
  },
  {
    name: "Work Modes",
    description: "Toggle between package/food delivery modes",
    enabled: true,
    category: "system",
  },
  ...
  {
    name: "Stripe Connect",
    description: "Stripe Connect for vendor payments",
    enabled: true,
    category: "payments",
  },
  {
  ...
  {
    name: "Proof Photos",
    description: "Require delivery proof photos",
    enabled: true,
    category: "system",
  },
  {
    name: "Package Shipping",
    description: "Enable package shipping service",
    enabled: true,
    category: "delivery",
  },
  ...
  // Package Runner
  {
    ...
    description: "Enable package runner network",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Hub Network",
    description: "Enable hub-to-hub shipping",
    enabled: true,
    category: "delivery",
  },
  {
    name: "Package Tracking",
    description: "Track packages across hubs",
    enabled: true,
    category: "system",
  },
  ...
  // Admin
  {
    name: "Courier Approval",
    description: "Manual courier approval workflow",
    enabled: true,
    category: "system",
  },
  {
    name: "Equipment Review",
    description: "Review courier equipment submissions",
    enabled: true,
    category: "system",
  },
  {
  ...
  {
    name: "System Logs",
    description: "View local admin-desktop logs",
    enabled: false,
    category: "system",
  },
  {
    name: "Firebase Explorer",
    description: "Read-only Firestore viewer",
    enabled: false,
    category: "system",
  },
  ...
  // Advanced
  {
    name: "Rating Enforcement",
    description: "Enforce rating requirements",
    enabled: true,
    category: "system",
  },
  {
    name: "Auto Cancel",
    description: "Auto-cancel stale jobs",
    enabled: true,
    category: "system",
  },
  {
...
export async function seedFeatureFlags() {
  try {
    ...
    console.log(
      `✅ Seeded ${FEATURE_FLAGS.length} feature flags + config document`,
    );
    return true;
  } catch (error) {
