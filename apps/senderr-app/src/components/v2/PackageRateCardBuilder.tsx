  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Distance Limits */}
        <div style={{ marginBottom: '24px', padding: '20px', background: '#f9fafb', borderRadius: '8px' }}>
          <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '16px' }}>Distance Limits (Optional)</h3>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <p style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>
              Maximum distance customers can be from pickup location
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>
              Maximum distance between pickup and dropoff locations
            </p>
          </div>
        </div>
