...
2. Read the relevant system docs in `/Users/papadev/dev/worktrees/gosenderr/SYSTEMS/`.
3. Use SYSTEMS docs as canonical references for architecture, boundaries, and ownership.

If other docs conflict, reconcile with SYSTEMS docs and governance docs before implementation.
